...
export default defineConfig({
  ...
  menus: {
    ...
    '/components': [
      ...
      {
        title: '展示组件',
        children: ['components/badge' ,'components/avatar', 'components/divider', 'components/count-down', 'components/empty', 'components/tag', 'components/card', 'components/progress', 'components/lazy-load'],
      },
      // {
      //   title: '导航组件',
      //   children: [],
