...
export const Tag: FunctionComponent<Partial<TagProps>> = props => {
  const { type = 'default', size = 'small', plain, shape, color, textColor, closeable } = props;
  ...
  return (
    <div className={varClasses} style={varStyles} onClick={props.onClick}>
      {renderIcon}
